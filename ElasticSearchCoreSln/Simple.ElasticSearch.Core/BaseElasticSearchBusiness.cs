...
namespace Simple.ElasticSearch.Core
{
    /// <summary>
    /// Base Elastic Search Business.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    public abstract class BaseElasticSearchBusiness<T> where T : class, new()
    {
        /// <summary>
        ...
        protected BaseElasticSearchBusiness(string uri, string indexName)
        {
